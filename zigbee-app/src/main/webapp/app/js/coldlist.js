...
$().ready(function() { 
	...
	function gethtml(rdc){
		  var html='<li class="imgCell" ng-repeat="rdc in rdcsList"><a href="colddetail.html?id='+rdc.id+'&rdcID='+rdc.rdcID+'"><img class="fl" src="'+rdc.logo+'"><div><p class="ellipsis">'+rdc.title+'</p><p class="position"><i class="iconfont">&#xe66e;</i>'+rdc.detlAddress+'</p><ul class="star"><li class="filled">★</li><li class="filled">★</li><li class="filled">★</li><li class="filled">★</li><li>★</li></ul></div></a><button class="grab" onclick="gosharedile('+rdc.id+');" >立即抢单</button></li>';
		  return html;
	}
