...
public class FileController  {
	...
	private static String baseDir = "textimg";
    @Autowired
	...
	@RequestMapping(value="/upTextFile")
	@ResponseBody
	public ResponseData<Object> upTextFile(HttpServletRequest request){
		try {
		...
		return ResponseData.newFailure("上传失败！");
	}
