...
public class RemoteServiceImpl implements RemoteService {
	...
	public Object insertDeviceObjectMapping(DeviceObjectMappingEntity deviceObjectMappingEntity) {
		String params = String.format("deviceid=%s&type=%s&oid=%s&rdcid=%s", deviceObjectMappingEntity.getDeviceid(),
				deviceObjectMappingEntity.getType(), deviceObjectMappingEntity.getOid(),
				deviceObjectMappingEntity.getRdcid());
