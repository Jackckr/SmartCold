...
(function ($) {
    function _80(_81) {
        ...
        for (var _86 = 0; _86 < aa.length; _86++) {
            ...
            if (_87 == "list") {
                ...
                $("<td>页码：</td>").append(ps).appendTo(tr);
            } else {
                if (_87 == "sep") {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, links: 5, layout: ["list", "sep", "first", "prev", "sep", "links", "sep", "next", "last", "sep", "refresh"], onSelectPage: function (_a6, _a7) {
        }, onBeforeRefresh: function (_a8, _a9) {
        }, onRefresh: function (_aa, _ab) {
        }, onChangePageSize: function (_ac) {
        }, beforePageText: "第", afterPageText: " 页/共 {pages} 页", displayMsg: "当前显示第 {from} 条 - 第 {to} 条 总共有 {total} 条数据", nav: {
            first: {
...
(function ($) {
    ...
    $.fn.panel.defaults = {
        id: null, title: null, iconCls: null, width: "auto", height: "auto", left: null, top: null, cls: null, headerCls: null, bodyCls: null, style: {}, href: null, cache: true, fit: false, border: true, doSize: true, noheader: false, content: null, collapsible: false, minimizable: false, maximizable: false, closable: false, collapsed: false, minimized: false, maximized: false, closed: false, tools: null, href: null, loadingMessage: "页面加载中，请稍候...", extractor: function (data) {
            var _229 = /<body[^>]*>((.|[\n\r])*)<\/body>/im;
...
(function ($) {
    ...
    var _688 = {
        render: function (_689, _68a, _68b) {
            ...
            for (var i = 0; i < _699.length; i++) {
                ...
                if (col) {
                    var _69f = eval("_69c['" + _69e.replace(/\./g, "']['") + "']"); //_69c[_69e]; //使easyui支持子属性点击
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "数据加载中，请稍等 ...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "desc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_6c3, _6c4) {
