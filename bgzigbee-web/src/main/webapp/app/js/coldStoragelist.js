...
coldWeb.controller('coldStoragelist', function ($rootScope, $scope, $state, $cookies, $http, $location) {
	...
	var  coldStoragelist={
			initTable:function(pageNum,pageSize){
//				    $http.post('/i/rdc/findRdcDTOList',{pageNum : pageNum,pageSize : pageSize}).success(function (data) {
...
//				    });
    ...
    $scope.pageChanged = function () {
    	 coldStoragelist.initTable($scope.bigCurrentPage, $scope.maxSize);
    }
    coldStoragelist.initTable($scope.bigCurrentPage, $scope.maxSize);
    // 获取当前冷库的列表
