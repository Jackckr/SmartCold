...
function logout(){$.messager.confirm('提示','确认退出账号?',function(r){if (r){$.ajax({ url: '/i/admin/logout',type: 'GET', success: function(data) { sysuser=undefined; window.sessionStorage.clear();top.location.href = "http://" + location.host + "/login.htm";}});}});}
