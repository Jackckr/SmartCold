...
function logout(){$.ajax({ url: '/i/admin/logout',type: 'GET', success: function(data) { sysuser=undefined; window.sessionStorage.removeItem("asikey");top.location.href = "http://" + location.host + "/login.htm";}});}
$().ready(function() {
