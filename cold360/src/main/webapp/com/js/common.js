...
// var ER = {root:"http://192.168.1.114:8080",coldroot:"http://192.168.1.114:8880"};
...
function setCookie (name,value){var Days = 30, exp = new Date();exp.setTime(exp.getTime() + Days*24*60*60*1000);document.cookie = name + "="+ escape (value) + ";expires=" + exp.toGMTString();}
