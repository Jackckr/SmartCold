...
public interface StorageKeyValueMapper {
	...
	List<StorageKeyValue> findByNums(@Param("table")String table , @Param("oid") Integer oid,@Param("key")String key, @Param("nums")Integer nums,@Param("startTime")Date startTime);
