...
public class CompressorGroupEntity {
    ...
    private int Compressor1;
    private int Compressor2;
    private int Compressor3;
    private int Compressor4;
    private int Compressor5;
    private int Compressor6;
    ...
    public int getCompressor1() {
        return Compressor1;
    }

    public void setCompressor1(int compressor1) {
        Compressor1 = compressor1;
    }

    public int getCompressor2() {
        return Compressor2;
    }

    public void setCompressor2(int compressor2) {
        Compressor2 = compressor2;
    }

    public int getCompressor3() {
        return Compressor3;
    }

    public void setCompressor3(int compressor3) {
        Compressor3 = compressor3;
    }

    public int getCompressor4() {
        return Compressor4;
    }

    public void setCompressor4(int compressor4) {
        Compressor4 = compressor4;
    }

    public int getCompressor5() {
        return Compressor5;
    }

    public void setCompressor5(int compressor5) {
        Compressor5 = compressor5;
    }

    public int getCompressor6() {
        return Compressor6;
    }

    public void setCompressor6(int compressor6) {
