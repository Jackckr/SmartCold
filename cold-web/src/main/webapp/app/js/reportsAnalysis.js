...
coldWeb.controller('reportsAnalysis', function ($scope, $http,$stateParams,$rootScope) {
	...
	var typemode={
			      ...
			      key:["'TotalPWC'","'WaterCost'","'OpenTimes','TotalTime','AvgTime';次数,时长(min),平均时长(min)","'ChaoWenShiJian','MaxTemp','ChaoWenYinZi','BaoWenYinZi';超温时长(min),最高温度(℃),超温因子(ε),保温因子(τ)","货物热量,化霜热量,叉车热量,照明热量,保温热量,冷风机风扇热量,开门热量;   ","'RunningTime','DefrosingTime';制冷时间(H),化霜时间(H)","","",""] 
	};
