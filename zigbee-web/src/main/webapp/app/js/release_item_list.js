...
coldWeb.controller('releaseItemList', function ($rootScope, $scope,$stateParams, $state, $cookies, $http, $location) {
     ...
     $scope.appmode=[{url1:""},{tolimg:["goods","outCur","offCur"],tool:[[1,"出货"],[2,"求货"]],btn:"发布货品"},{tolimg:["car","carCur","noCaRcur"],tool:[[1,"有车"],[2,"求车"]],btn:"发布货品"},{tolimg:["rent","rentCur","noRentCur"],tool:[[1,"出租"],[2,"求租"]],btn:"发布仓库"}];
