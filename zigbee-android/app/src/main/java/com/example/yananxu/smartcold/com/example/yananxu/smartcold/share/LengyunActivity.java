...
public class LengyunActivity extends FragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_share_lengyun);

        fragmentManager = getSupportFragmentManager();
        chuzuBtn = (Button) findViewById(R.id.share_zhaohuo);
        qiuzuBtn = (Button) findViewById(R.id.share_zhaoche);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.share_zhaohuo:
                    showFragment(FRAGMENT_ONE);
                    break;
                case R.id.share_zhaoche:
        ...
        switch (index){
            ...
            case FRAGMENT_ONE:
                ...
                if (oneFm == null){
                    ...
                    ft.add(R.id.share_lengyun_content, oneFm);
                }else {
                    ft.show(oneFm);
                }
            ...
            case FRAGMENT_TWO:
                if (twoFm == null){
                    ...
                    ft.add(R.id.share_lengyun_content, twoFm);
                }else {
                    ft.show(twoFm);
                }
